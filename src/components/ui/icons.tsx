...
export const LinkUploadIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
// New interactive sidebar toggle icon
export const SidebarToggleIcon: React.FC<{ className?: string; isOpen?: boolean }> = ({
  className = "w-5 h-5",
  isOpen = false,
}) => (
  <svg
...
// Alternative modern panel icon
export const PanelLeftIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2}
      d="M9 3H5a2 2 0 00-2 2v14a2 2 0 002 2h4m6-6h6m-6-4h6m-6-4h6"
    />
  </svg>
)
